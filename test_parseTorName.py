...
@pytest.mark.parametrize("test_input, e1, e2, e3, e4", [
    ...
    ('[WARP276] Danny Brown - Atrocity Exhibition (2016) [FLAC]', 'Danny Brown Atrocity Exhibition', '2016', '', ''),
    ...
    ('Stefanie Sun (孫燕姿) - Against the Light (逆光) (2007) - FLAC', 'Against the Light 逆光', '2007', '', ''),
